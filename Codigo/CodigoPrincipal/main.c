...
int main() {
 setlocale(LC_ALL, "Portuguese");
    ...
    do {
        ...
        printf("2. Cadastrar Assento\n");
        printf("3. Listar Assentos\n");
        printf("4. Listar Voos\n");
        printf("5. Cadastrar tripulantes e passageiros \n");
        printf("6. Fazer uma reserva\n");
        printf("7. Exibir todas as reservas\n");
        printf("8. Baixar reserva\n");
        printf("9. Pesquisar Passageiro ou Tripulante\n");
        printf("10. Pontos de fidelidade de um Passageiro\n");
        printf("0. Sair\n");
        ...
        switch (opcao) {
            case 1:
                cadastrarVoo(); // Chama a funcao para cadastrar voo
                break;
            case 2:
                cadastrarAssento(); // Chama a funcao para cadastrar assento
                break;
            case 3:
                listarAssentos(); // Chama a funcao para listar assentos
                break;
            case 4:
                listarVoos(); // Chama a funcao para listar voos
                break;
            case 5:
                executar_menu(); //cadastro de passageiro e tripulante
                break;
            case 6:
                reservar_assento(); //cadastro de passageiro e tripulante
                break;
                  case 7:
               exibir_reservas()  ; //cadastro de passageiro e tripulante
                break;
                  case 8:
                    baixar_reserva(); // baixar reserva
                    break;
                  case 9:
                    pesquisar_pessoa();  // Pesquisa de Passageiro ou Tripulante
                    break;
                  case 10:
    ...
    } while (opcao != 0); // Repete ate a opcao 0 ser selecionada (sair)
